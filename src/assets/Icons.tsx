...
export const HomeIcon: Icon = (props) => {
  return (
    <svg
      aria-hidden="true"
      className="Svg-sc-ytk21e-0 iYxpxA home-active-icon"
      data-encore-id="icon"
      viewBox="0 0 24 24"
      fill="currentcolor"
      {...props}
...
export const LibraryIcon: Icon = (props) => {
  return (
    <svg
      aria-hidden="true"
...
export const VolumeMediumIcon: Icon = (props) => {
  return (
    <svg
      aria-hidden="true"
...
export const VolumeMinimumIcon: Icon = (props) => {
  return (
    <svg
      aria-hidden="true"
...
export const VolumeMuteIcon: Icon = (props) => {
  return (
    <svg
      aria-hidden="true"
